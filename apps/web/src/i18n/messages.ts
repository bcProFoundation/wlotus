...
const en: Dict = {
  ...
  pushRemindWait: 'Morning memorial reminder',
  ...
  homeEventsEmptyTrending: 'No offerings in the last 24 hours.',
...
const vi: Dict = {
  ...
  pushRemindWait: 'Nhắc buổi sáng ngày giỗ',
  ...
  homeEventsEmptyTrending: 'Chưa có lễ nào trong 24 giờ qua.',
...
const zh: Dict = {
  ...
  homeEventsEmptyTrending: '过去 24 小时暂无供奉。',
